...
def right_clockwise(cube_state):
    ...
    for i in range(0, -3, -1):
        locations_vector = []
        for j in range(-1, -4, -1):
            locations_vector.append(3*(9 + i) + j)
        locations_matrix.append(locations_vector)
...
def front_clockwise(cube_state):
    # Helper function to change colors during rotation
    def change_colors(colors):
        colors[4], colors[2], colors[5], colors[3] = colors[2], colors[5], colors[3], colors[4]
        return colors
    ...
    for i in range(0, -3, -1):
        locations_vector = []
        for j in range(1, 4, 1):
            locations_vector.append(9*j + 3*i -1)
        locations_matrix.append(locations_vector)
...
def front_counter_clockwise(cube_state):
    # Helper function to change colors during rotation
    def change_colors(colors):
        colors[5], colors[3], colors[4], colors[2] = colors[2], colors[5], colors[3], colors[4]
        return colors
...
def back_counter_clockwise(cube_state):
    # Helper function to change colors during rotation
    def change_colors(colors):
        colors[4], colors[2], colors[5], colors[3] = colors[2], colors[5], colors[3], colors[4]
        return colors
